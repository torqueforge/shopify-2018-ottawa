...
class DescendingVerseSongTest < Minitest::Test
  def test_a_couple_verses
    ...
    assert_equal expected, DescendingVerseSong.new.verses(99, 98)
  end
  ...
  def test_a_few_verses
    expected = "2 bottles of beer on the wall, " +
      ...
      "Go to the store and buy some more, " +
      "99 bottles of beer on the wall.\n"
    assert_equal expected, DescendingVerseSong.new.verses(2, 0)
  end
  ...
  def test_the_whole_song
    ...
    SONG
    assert_equal expected, DescendingVerseSong.new.song
  end
end
